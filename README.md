...
Sou um profissional híbrido de **negócio e tecnologia**, com experiência em **gestão de produto, arquitetura de software e metodologias ágeis**.  
Atuo na ponte entre **discovery, UX e engenharia**, conectando visão de produto à entrega técnica — sempre com foco em **valor, automação e qualidade (BDD/TDD)**.
...
Formado em **Administração Pública pela FGV-EAESP**, transicionei para **Engenharia de Software** e venho atuando como **PO técnico e arquiteto de software**, conduzindo squads em projetos web e mobile.  
Tenho experiência multissetorial — **ESG, GovTech, Educação, Saúde, Fintech e Sustentabilidade** — e desenvolvo produtos com base em práticas ágeis, discovery contínuo e cultura DevOps.
...
## 🤝 Projetos realizados via Code Tech (contrato PJ)

> 🔑 Alguns projetos descritos abaixo foram conduzidos sob contrato PJ com a **Code Tech**.  
> As informações foram adaptadas para preservar confidencialidade e direitos autorais dos clientes, mantendo o foco em práticas, resultados e impacto.

Durante minha atuação como **Product Owner, Arquiteto de Software e Gestor de Projeto**, liderei entregas em múltiplos produtos web e mobile, conectando visão de produto, arquitetura e engenharia.  
Os projetos envolveram coordenação de times multifuncionais, modelagem de fluxos (BPMN), documentação (PRDs, BDD), governança de backlog e integração contínua (CI/CD).
...
Aberto a oportunidades em **gestão de produto técnico, arquitetura de software e inovação com IA aplicada**.  
📬 Fale comigo pelo [LinkedIn](https://linkedin.com/in/brunobogochvol) ou e-mail: [brunobogochvol@gmail.com](mailto:brunobogochvol@gmail.com).

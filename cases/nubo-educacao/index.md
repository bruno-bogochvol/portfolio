...
## 💡 Desafios
- Criar um **agente de IA (Cloudinha)** capaz de orientar alunos de forma personalizada.
- Orquestrar uma arquitetura **multi-tenant e multi-repo** com deploy automatizado.
- Garantir escalabilidade para milhares de oportunidades educacionais e usuários simultâneos.

---

## ⚙️ Entregas Chave
- **Desenvolvimento Full-Stack:** Arquitetura, UX/UI e implementação de código.
- **Integração de IA:** Uso do **Google ADK** para o agente inteligente.
- **Infraestrutura:** Pipelines de CI/CD para **GCP e Vercel**, com gestão de dados no **Supabase**.
- **Operações:** Configuração de domínios e segurança (GoDaddy/Cloudflare).

---

## 📈 Resultados
- **+2500 usuários ativos**.
- **+400 matches** entre alunos e oportunidades.
- **+160 mil oportunidades** cadastradas na base.
- **Cloudinha Agent** operando como assistente virtual principal.
